...
const Grainient = ({
  ...
  useEffect(() => {
    ...
    const uniformValues = {
      ...
      uGrainAnimated: grainAnimated ? 1.0 : 0.0,
      uContrast: contrast,
      uGamma: gamma,
    ...
    const centerOffset = new Float32Array([centerX, centerY]);
    const loc1 = getLocation('uCenterOffset');
    if (loc1) gl.uniform2fv(loc1, centerOffset);

    const rgb1 = hexToRgb(color1);
    const rgb2 = hexToRgb(color2);
    const rgb3 = hexToRgb(color3);

    const loc2 = getLocation('uColor1');
    if (loc2) gl.uniform3fv(loc2, new Float32Array(rgb1));
    const loc3 = getLocation('uColor2');
    if (loc3) gl.uniform3fv(loc3, new Float32Array(rgb2));
    const loc4 = getLocation('uColor3');
    if (loc4) gl.uniform3fv(loc4, new Float32Array(rgb3));
  }, [
