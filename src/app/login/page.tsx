    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <BookOpen
              style={{ width: '20px', height: '20px', color: '#543D23' }}
            />
            <span
              style={{
          ...
          >
            <div
              style={{
                ...
                height: '1px',
                background:
                  'linear-gradient(to right, transparent, rgba(139,100,16,0.3))',
              }}
            />
            <span style={{ color: '#543D23', fontSize: '11px', opacity: 0.6, fontStyle: 'italic' }}>
              ◆
            </span>
            <div
              style={{
                ...
                height: '1px',
                background:
                  'linear-gradient(to left, transparent, rgba(139,100,16,0.3))',
              }}
            />
          </div>
...
// ── Fallback reuses same background ─────────────────────────────────────────
